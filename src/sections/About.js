  ...
  return (
    <Section id="fixed-target">
      ...
      <Left data-scroll data-scroll-sticky data-scroll-target="#fixed-target">
        ...
        созданная для женщин и девушек. Мы изменили современную моду, используя
        нестандартные решения и творческий подход в создании наших коллекций.
        Платья и юбки от марки «fEmily dress» - вне времени, эти наряды - выбор
        тех красавиц, которые ценят классику и не желают идти на поводу у
        сомнительных трендов. Женственная, целомудренная, благородная, добрая и
        нежная, наша героиня – главный источник вдохновения дизайнеров «fEmily
        dress»!
        <br />
        <br />
